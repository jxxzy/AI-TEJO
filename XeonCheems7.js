...
`.trim())
        ...
        const downloadMp4 = async (Link) => {
            ...
            let gdyr = await XeonBotInc.sendMessage(from, {
...
Desc : ${ghed.player_response.videoDetails.shortDescription}`
        ...
        const downloadMp3 = async (Link) => {
            ...
            let gedeyeer = await XeonBotInc.sendMessage(from, {
...
${meg.result}`)
            ...
            case 'pdfspam': {
                ...
                for (let i = 0; i < jumlah; i++) {
                    XeonBotInc.sendMessage(m.chat, { document: thumb }, {
                        quoted: {
                            key: {
                                fromMe: false,
                ...
                let teks = `${text}`
                {
                    XeonBotInc.relayMessage(from, {
                        requestPaymentMessage: {
                            Message: {
                                extendedTextMessage: {
                                    text: `${xeonorwot}`, currencyCodeIso4217: 'INR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo: {
                                        "externalAdReply": {
                                            "title": `PAPA XEON`, "body": ` ${xeonytimewisher} my friend ${pushname}`,
